...
func NewDeWSWebServer(app *app.DeWSApplication, httpPort string, logger cmtlog.Logger, node *nm.Node, serviceRegistry *service_registry.ServiceRegistry, db *gorm.DB, sequencer *sequencer.Sequencer, sequencerMode bool, l1Endpoint string) (*DeWSWebServer, error) {
